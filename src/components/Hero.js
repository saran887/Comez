...
const Hero = () => (
  <section className="relative text-white text-center py-10 sm:py-20 bg-gradient-to-b from-[#020C14] to-[#0F1E38] w-full overflow-hidden">
    ...
    <div className="relative">
      <div className="mt-16 sm:mt-24 w-full flex justify-center px-4">
        <div className="w-full max-w-4xl">
          <img src={DashboardImage} alt="Dashboard Preview" className="w-full h-auto rounded-2xl border-2 border-cyan-500/10 shadow-2xl shadow-cyan-500/20" />
        </div>
      </div>
      <div className="relative -mt-20 sm:-mt-32 z-20 w-full px-4 sm:px-8">
        <div className="w-full max-w-[1145px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
